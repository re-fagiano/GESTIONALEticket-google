...
If you cannot or do not want to provide a key, the AI panel now returns a quick offline diagnosis using rule-based tips so the workflow still produces actionable hints without DeepSeek credentials.
